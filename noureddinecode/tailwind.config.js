    ...
    extend: {
      colors: {
        ...
        brand: {
          ...
          accent: "var(--color-brand-accent)", // cyan-500
          surface: "var(--color-brand-surface)", // slate-50
        },
        text: {
      ...
      boxShadow: {
        ...
        'interactive': '0 4px 12px rgba(30, 58, 138, 0.15)',
      },
      animation: {
        'typewriter': 'typing 3s steps(40, end), blink-caret 0.75s step-end infinite',
        'pulse-subtle': 'pulse-subtle 4s ease-in-out infinite',
        'signal-flow': 'signal-flow 2s ease-in-out forwards',
      ...
      keyframes: {
        ...
        'blink-caret': {
          ...
          '50%': { borderColor: 'var(--color-brand-secondary)' }
        },
        'pulse-subtle': {
          '0%, 100%': { opacity: '0.3' },
          '50%': { opacity: '0.8' }
