  ...
  return (
    <section className="mb-16">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-3xl font-bold text-text-primary mb-2">Featured Series</h2>
          <p className="text-text-secondary">Deep-dive technical series on embedded systems</p>
        </div>
        <Link
            ...
            <div className="p-6">
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-text-muted text-sm">{item?.totalReadTime} min total</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Icon name="TrendingUp" size={16} className="text-success" />
                  <span className="text-success text-sm font-medium">{item?.difficulty}</span>
                </div>
              </div>
              ...
              <Link
                to={`/industry-insights-hub/series/${item?.slug}`}
